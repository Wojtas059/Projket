...
def Upload():
    ...
    Builder.load_file('kivy_bulider/advance_widget/a_choose_users_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_start_guest_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_choose_method_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_choose_lots_muscles_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_managment_sensors_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_start_reference_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_reference_instr_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_observation_ref_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_finish_ref_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_observation_exp_widget.kv')
    Builder.load_file('kivy_bulider/advance_widget/a_pauze_exp_widget.kv')