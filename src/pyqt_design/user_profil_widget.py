    ...
    def retranslateUi(self):
        ...
        self.name.setText(
            _translate(
                ...
                + str(self.parent().user_login.get_name())
                + " "
                + str(self.parent().user_login.get_surname()),
            )
        )
        self.email.setText(
            _translate(
                "ManagmentSensor",
                "Twój email: " + str(self.parent().user_login.get_email()),
            )
        )
        self.login.setText(
            _translate(
                "ManagmentSensor",
                "Twój login: " + str(self.parent().user_login.get_login()),
            )
        )
    ...
    def changePassword(self):
        ...
        if not self.password.text().__eq__(""):
            if self.password.text().__eq__(self.confirm_pass.text()):
                ...
                database_handler.updatePasswordByUserPassword(
                    self.parent().user_login.get_id(), self.password.text()
                )
