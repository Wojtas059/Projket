# Form implementation generated from reading ui file '.\ui_file\user_profil_widget.ui'
#
...
class UserProfilSee(QWidget):
    def __init__(self, parent):
        ...
        self.pass_change = QtWidgets.QLabel(self)
        ...
        self.pass_label = QtWidgets.QLabel(self)
        ...
        self.change_pass = QtWidgets.QPushButton(self)
    ...
    def retranslateUi(self):
        ...
        self.name.setText(_translate("ManagmentSensor", "Twoje imie i nazwisko: "+str(self.parent().user_login.get_name())+" "+str(self.parent().user_login.get_surname())))
        self.email.setText(_translate("ManagmentSensor", "Twój email: "+str(self.parent().user_login.get_email())))
        self.login.setText(_translate("ManagmentSensor", "Twój login: "+str(self.parent().user_login.get_login())))
    ...
    def addActionButtons(self):
        ...
        self.change_pass.clicked.connect(lambda: self.changePassword())
    ...
    def changePassword(self):
        ...
        if not self.password.text().__eq__("") :
            if self.password.text().__eq__(self.confirm_pass.text()) :
                database_handler = DatabaseHandler()
                database_handler.createConnection()
                database_handler.updatePasswordByUserPassword(self.parent().user_login.get_id(), self.password.text() )
                database_handler.closeConnection()
                self.createMessageBox("Twoje hasło zostało zmienione")
