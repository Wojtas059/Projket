...
_DATAPACKET = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="constantValue",
            full_name="DataPacket.constantValue",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="packetNumber",
            full_name="DataPacket.packetNumber",
            index=4,
            number=5,
            type=13,
            cpp_type=3,
...
_DEVICEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="ledState",
            full_name="DeviceRequest.ledState",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
LED = _reflection.GeneratedProtocolMessageType(
    "LED",
    (_message.Message,),
    {
        "DESCRIPTOR": _LED,
...
DeviceRequest = _reflection.GeneratedProtocolMessageType(
    "DeviceRequest",
    (_message.Message,),
    {
...
DeviceResponse = _reflection.GeneratedProtocolMessageType(
    "DeviceResponse",
    (_message.Message,),
    {
