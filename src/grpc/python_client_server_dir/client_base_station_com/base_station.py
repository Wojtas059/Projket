    ...
    def sendSpiritData(self):
        ...
        while True:
            try:
                ...
                print(
                    "Received {} packets".format(self._spirit_manager.received_packets)
                )
                print(
                    "Last received packet had ID = {}".format(
                        self._spirit_manager.last_received_packet_id
                    )
                )
                print(
                    "We lost {} packets, which is {:.2f}%".format(
                        self._spirit_manager.last_received_packet_id
                        - self._spirit_manager.received_packets,
                        (
                            1
                            - (
                                self._spirit_manager.received_packets
